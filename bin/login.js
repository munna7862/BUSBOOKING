    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, driver.get("https://opensource-demo.orangehrmlive.com/")];
                case 4:
                    _a.sent();
                ...
                case 5:
                    ...
                    return [4 /*yield*/, Promise.all([
                            ...
                            driver.findElement(selenium_webdriver_1.By.id("txtPassword")).sendKeys("admin")
                        ]).then(function () {
